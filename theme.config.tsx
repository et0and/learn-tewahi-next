...
const config: DocsThemeConfig = {
  ...
  docsRepositoryBase: 'https://github.com/et0and/learn-tewahi-next/pages',
  useNextSeoProps() {
  ...
  head: function useHead() {
    ...
    return (
      <>
        ...
        <meta
          name="description"
          content="The Te Wāhi Learning Hub."
        />
        <meta
          name="og:description"
          content="The Te Wāhi Learning Hub."
        ...
        <meta
          name="og:title"
          content={title ? title + ' – Te Wāhi Learn' : 'Te Wāhi'}
        />
    ...
    text: (
      <div className="flex w-full flex-col items-center sm:items-start">
        <p className="mt-6 text-xs">
          © {new Date().getFullYear()} Te Wāhi Auaha.
        </p>
      </div>
    )
  }
