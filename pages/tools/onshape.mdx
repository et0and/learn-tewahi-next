...
OnShape can run on most machines, but requires a fast internet connection and benefits from an external mouse and keyboard. Full system requirements are available below.
</Callout>
