...
Fusion 360 requires a powerful Windows or Mac computer with a mouse and keyboard to run well. It can be run on a Chromebook via a web app but requires a fast internet connection. Full system requirements are available below.
</Callout>
