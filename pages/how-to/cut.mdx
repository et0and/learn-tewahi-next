...
![ULS selection screen](https://cdn.tewahi.me/cut11.png)
...
Now go to the **Manual Config** tab, and make sure the following settings are selected:
...
With these numbers entered, hit **Set**, **Apply**, then **Print**! 

![Print dialog flow Windows](https://cdn.tewahi.me/cut13.png)
