    ...
    <>
      ...
      <div>
        ...
        >
          ...
          <ContentSection content={data.project.body}></ContentSection>
        </div>
...
export const getStaticPaths = async () => {
  const connection = await client.queries.projectsConnection()
  return {
    paths: connection.data.projectsConnection.edges.map((post) => ({
